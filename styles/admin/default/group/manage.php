    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">Group Name </label>

                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Group Name" name="title"
            ...
            <div class="form-group-separator"></div>
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Group Kewords; seperate with comma" name="keyword"
            ...
            <div class="form-group-separator"></div>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                   <textarea style=""class="form-control" placeholder="Short Description" name="short"><?php echo set_value('short', $item->short) ?></textarea>
                </div>
            </div>
            <div class="form-group-separator"></div>
            
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">Group Details</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="<?php echo site_url('admin/group/index'); ?>" class="btn btn-danger">Cancel</a>
                </div>
            </div>
