    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-progress-counter xe-progress-counter-turquoise"  data-count=".num" data-from="0" data-to="<?php echo $events ?>" data-suffix="" data-duration="3">
                    ...
                    <div class="xe-upper">
                        ...
                        <div class="xe-label">
                            <span> Events</span>
                            <strong class="num"><?php echo $events ?></strong>
                        </div>
                    </div>
