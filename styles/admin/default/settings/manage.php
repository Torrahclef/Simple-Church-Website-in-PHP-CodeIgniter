            ...
            <div class="col-md-12">
                ...
                <div class="tab-content">
                  ...
                  <div class="form-group-separator"></div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Analytic Code</label>
                            <div class="compose-message-editor col-sm-10">
                                <textarea style="height: 150px;" class="form-control" name="setting[analytic]"><?php echo set_value('setting[analytic]', $item->analytic) ?></textarea>
                            </div>
                        </div>
