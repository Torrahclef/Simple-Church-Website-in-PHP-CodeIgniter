...
<div class="panel panel-default">
 ...
 <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="News Keword; Seperate with comma" name="keyword"
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">News Details</label>
