				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="highlight bold">News Updates</h2>
							<ol class="breadcrumb">
								<li>
											...
											<div class="item-content flex-content">
												...
												<div class="with_padding">
													...
													<h3 class="entry-title">
														<a href="<?php echo site_url('post/index/' . $item->blog_id) ?>" rel="bookmark"><?php echo $item->title ?></a>
													</h3>

													<p>  <?php $this->load->helper('text') ?>
                                        <?php echo word_limiter($item->description, 50) ?></p>
