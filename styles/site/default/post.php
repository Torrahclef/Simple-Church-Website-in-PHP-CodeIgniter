...
<!-- AddToAny END -->
	...
	<div class="row columns_padding_5 page-nav">
              <?php foreach ($this->db->where('blog_id !=', $item->blog_id)->get('blog', 2)->result() as $post): ?>
								<div class="col-md-6">
									<div class="with_padding_small text-center ds bg_teaser after_cover darkgrey_bg">
										...
										<div class="item-content">
											...
											<h4>
												<a href="<?php echo site_url('post/index/' . $post->blog_id) ?>" rel="bookmark"><?php echo $post->title ?></a>
											</h4>
										</div>
										<!-- eof .item-content -->
									</div>
